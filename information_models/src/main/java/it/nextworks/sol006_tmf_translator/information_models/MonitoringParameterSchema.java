...
/**
 * MonitoringParameterSchema
 */

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen", date = "2021-03-09T19:09:38.446+01:00[Europe/Rome]")


public class MonitoringParameterSchema   {
  ...
  public MonitoringParameterSchema performanceMetric(String performanceMetric) {
  ...
  public MonitoringParameterSchema collectionPeriod(String collectionPeriod) {
  ...
  public MonitoringParameterSchema id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MonitoringParameterSchema name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MonitoringParameterSchema monitoringParameterSchema = (MonitoringParameterSchema) o;
    return Objects.equals(this.performanceMetric, monitoringParameterSchema.performanceMetric) &&
        Objects.equals(this.collectionPeriod, monitoringParameterSchema.collectionPeriod) &&
        Objects.equals(this.id, monitoringParameterSchema.id) &&
        Objects.equals(this.name, monitoringParameterSchema.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitoringParameterSchema {\n");
