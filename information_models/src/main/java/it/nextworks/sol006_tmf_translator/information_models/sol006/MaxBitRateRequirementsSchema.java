...
public class MaxBitRateRequirementsSchema   {
  @JsonProperty("leaf")
  ...
  public MaxBitRateRequirementsSchema leaf(String leaf) {
    this.leaf = leaf;
    return this;
  }
  ...
  public MaxBitRateRequirementsSchema root(String root) {
    this.root = root;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MaxBitRateRequirementsSchema maxBitRateRequirementsSchema = (MaxBitRateRequirementsSchema) o;
    return Objects.equals(this.leaf, maxBitRateRequirementsSchema.leaf) &&
        Objects.equals(this.root, maxBitRateRequirementsSchema.root);
  }
  ...
  public String toString() {
    ...
    sb.append("class MaxBitRateRequirementsSchema {\n");
