...
/**
 * VnfdRequestadditionalcapability
 */

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen", date = "2021-03-09T19:09:38.446+01:00[Europe/Rome]")


public class VnfdRequestadditionalcapability   {
  ...
  public VnfdRequestadditionalcapability supportMandatory(Boolean supportMandatory) {
  ...
  public VnfdRequestadditionalcapability minVersion(String minVersion) {
  ...
  public VnfdRequestadditionalcapability name(String name) {
    this.name = name;
    return this;
  }
  ...
  public VnfdRequestadditionalcapability targetPerformanceParameters(List<VnfdVdustoragerequirements> targetPerformanceParameters) {
    this.targetPerformanceParameters = targetPerformanceParameters;
    return this;
  }

  public VnfdRequestadditionalcapability addTargetPerformanceParametersItem(VnfdVdustoragerequirements targetPerformanceParametersItem) {
  ...
  public VnfdRequestadditionalcapability preferredVersion(String preferredVersion) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VnfdRequestadditionalcapability vnfdRequestadditionalcapability = (VnfdRequestadditionalcapability) o;
    return Objects.equals(this.supportMandatory, vnfdRequestadditionalcapability.supportMandatory) &&
        Objects.equals(this.minVersion, vnfdRequestadditionalcapability.minVersion) &&
        Objects.equals(this.name, vnfdRequestadditionalcapability.name) &&
        Objects.equals(this.targetPerformanceParameters, vnfdRequestadditionalcapability.targetPerformanceParameters) &&
        Objects.equals(this.preferredVersion, vnfdRequestadditionalcapability.preferredVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class VnfdRequestadditionalcapability {\n");
